...
<u:page title="Список заказов для обработки" mainMenu="true" css="/resources/css/table.css">
    <div class="tables">
        <table>
            <tr>
                <th>Намер заказа</th>
            ...
            <c:forEach var="order" items="${ordersList}" >
                <tr>
                    ...
                    <td><c:url var="modEdit" value="/models/edit"/>
                        <a href="${carList}" class="form_button_edit">Edit</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
